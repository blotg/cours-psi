...
- Identifier et représenter les enchainements donnant lieu à une délocalisation électronique.
...
- Prévoir et interpréter les structures de type $"AX"_n$ avec $n <= 4$ et $"AX"_p "E"_q$, avec $p + q = 3$ ou $4$.
...
- Interpréter la stabilité d’un conformère donné.
