...
- Justifier que l’enthalpie $H_m$ d’une phase condensée peu compressible et peu dilatable peut être considérée comme une fonction de l’unique variable $T$.
...
- #compétence-TP Mettre en œuvre un protocole expérimental de mesure d'une grandeur thermodynamique énergétique (capacité thermique, enthalpie de fusion, etc.).
