...
#exercice(
    ...
    #question(coups-de-pouce: (
        ...
        *Choix de la courbe d'Ampère*
        On choisit une courbe circulaire de rayon $r$ centrée sur l'axe du fil.
        ...
        *Théorème d'Ampère*
        ...
        Dans le tore (matériau doux hors saturation), on a $va(B) = mu va(H)$ donc $ va(B)_I = (mu I(t))/(2 pi r) va(e_theta) $
    ...
    #question(coups-de-pouce: (
        ...
        *Choix de la courbe d'Ampère*
        On choisit une courbe circulaire de rayon $r$ centrée sur l'axe du tore.

        *Théorème d'Ampère*
        On applique le théorème d'Ampère sur cette courbe :
        $integral.cont va(H) dot va(dd(l)) = integral.cont H va(e_theta) dot dd(l) va(e_theta) = 2 pi r H = I_"enlacé"$. Le courant enlacé est nul pour une courbe d'Ampère en dehors du tore. À l'intérieur, il vaut  $I_"enlacé" = i(t) N$ d'où l'excitation à l'intérieur du tore : $ va(H) = (i(t) N)/(2 pi r) va(e_theta) $

        Dans le tore (matériau doux hors saturation), on a $va(B) = mu va(H)$ donc $ va(B)_i = (mu N i(t))/(2 pi r) va(e_theta) $
    ...
    #question(coups-de-pouce: (
        ...
        On peut en déduire que $u(t) = R i(t)$ et que $u(t) = -dv(Phi,t) = -dv(Phi_i+Phi_I,t)$ d'où l'équation différentielle :
    ...
    #question(coups-de-pouce: (
        ...
        $ H(p) = (U(p))/(I(p)) = (-(mu a N)/(2 pi) ln(1+a/b)p)/(1+(a N^2 mu)/(2 pi R) ln(1+a/b)p ) $

        Pour que $u$ soit proportionnel à $I$, il faut que la fonction de transfert soit indépendante de $p$, i.e. que $1 << (a N^2 mu)/(2 pi R) ln(1+a/b)p$ soit $a N^2 mu ln(1+a/b) omega >> 2 pi R$.
    ]
