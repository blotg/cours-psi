...
#question(
    ...
    Il existe des matériaux qui peuvent être aimantés : lorsqu'ils sont soumis à un champ magnétique, ils restent aimantés même lorsqu'on retire le champ magnétique extérieur. Cet effet "mémoire" (l'état du matériau dépend de son histoire) est appelé hystérésis.
    ...
    En faisant passer du courant dans la bobine de la tête de lecture, celle-ci produit un champ magnétique qui peut aimanter le plateau. En inversant le sens du courant, on inverse le sens de l'aimantation. On peut ainsi stocker un tout petit morceau d'information binaire (0 ou 1) en fonction du sens de l'aimantation locale du plateau.
