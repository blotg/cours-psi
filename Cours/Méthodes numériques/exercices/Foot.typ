...
On prend maintenant en compte les frottements avec l'air $va(F) = - 1/2 pi rho C_x R^2 ||va(v)|| va(v)$. On donne les valeurs numériques suivantes :
$rho = #qty("1.2", "kg/m^3")$,
$C_x = #num("0.47")$,
$R = #qty("0.11", "m")$ et
$m = #qty("145", "g")$
