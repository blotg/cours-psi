...
#question(
    ...
    Les lignes électriques ne sont pas toutes aux mêmes tensions. Par exemple, les lignes à haute tension (#quan[400 kV]) sont utilisées pour le transport de l'électricité sur de longues distances, tandis que les lignes basse tension (#quan[230 V]) sont utilisées pour la distribution locale aux foyers et aux entreprises.
