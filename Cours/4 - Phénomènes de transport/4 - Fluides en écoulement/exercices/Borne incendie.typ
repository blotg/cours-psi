...
#question(
    ...
    $
        R_(e,1) = (U D)/nu = (D_V/S D mu)/eta = (D_V D mu)/(eta pi D^2/4) = (4 D_V mu)/(eta pi D) = #num(scientifique(Re1, 2))
    $
    ...
    #let Pc = P0 + mv * g * h
    $
      P_"château" = P_0 + mu g h = #qty(scientifique(Pc,2), "Pa")
    $
