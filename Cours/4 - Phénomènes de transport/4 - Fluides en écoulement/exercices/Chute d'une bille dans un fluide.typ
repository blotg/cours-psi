...
#question(
    ...
    #let p = 0.029/2.4e-6
    Une lecture graphique donne une pente de $p=qty("0.029", "m/s")/qty("2.4", "mm^2") = #qty(p, "/s/m", chiffres: 2)$.
...
#question(
    ...
    La plus grosse bille ($R = #qty("1.5", "mm")$) atteint $v_"lim" = #qty(v, "m/s", chiffres: 2)$, d'où
