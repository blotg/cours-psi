...
= Déterminer la forme de $va(j)$
+ La forme de $j$ dépend de la géométrie du conducteur et est liée à la conservation de la charge en régime stationnaire. En régime stationnaire, $va(j)$ est à flux conservatif. 
+ Déterminer les dépendances de $va(j)$.
+ Intégrer $va(j)$ sur une surface sur laquelle $j$ est uniforme pour faire apparaitre le courant $I$.
+ Cette intégrale est constante, ce qui permet d'isoler $va(j)$ et d'en déterminer la forme.