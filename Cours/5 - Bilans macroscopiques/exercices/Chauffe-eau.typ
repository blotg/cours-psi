...
Le chauffe-eau ci-dessous peut soutirer une puissance électrique maximale de #quan[4.4 kW].
...
Le débit d'eau dans une douche est typiquement compris entre #quan[12 L/min] et #quan[20 L/min].

La capacité thermique massique de l'eau est $c_p = #quan[4.18 kJ/kg/K]$.
...
#question()[
    ...
    $
    En supposant une température d'entrée de #quan[10 °C] et une température de sortie de #quan[37 °C], on trouve que le chauffe-eau peut fournir un débit maximal de 
    #let P = 4400
    #let mv = 1e3
    #let capa = 4.18e3
    #let Tentree = 10
    ...
    $
    C'est très en deçà des #quan[12 L/min] à #quan[20 L/min] d'une douche : ce chauffe-eau ne convient pas. Il pourrait tout au plus alimenter un lavabo.
]
