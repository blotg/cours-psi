...
#question()[
    ...
    L'impédance d'entrée de l'amplificateur non-inverseur est infinie, donc très grande devant l'impédance de sortie du GBF (#quan[50 Ω] habituellement) quelles que soient les valeurs des résistances choisies.

    On peut par exemple choisir des résistances de #quan[10 kΩ] pour $R_1$ et $R_2$.
    ...
    circuit({
        ...
        resistor("R2", (0, -2), label: quan[10 kΩ])
        resistor("R1", (-1.5, -2), (-1.5,-4), label: quan[10 kΩ])
