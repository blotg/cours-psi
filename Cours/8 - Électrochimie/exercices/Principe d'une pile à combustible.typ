...
Données : $E^circ(ce("O2/H2O")) = #quan[1.23 V]$ à $#quan[298 K]$ ; $Delta_f H^circ(ce("H2O(l)")) = #quan[-285.10 kJ/mol]$ ; $S_m^circ$ : #ce("H2O(l)") $#quan[69.96 J/mol/K]$, #ce("H2(g)") $#quan[130.46 J/mol/K]$, #ce("O2(g)") $#quan[204.82 J/mol/K]$.
...
#question(coups-de-pouce: (
  ...
  Couples : #ce("O2/H2O") ($#quan[1.23 V]$) et #cpl("H+", "H2") ($#quan[0 V]$). #ce("O2") est le meilleur oxydant, #ce("H2") le meilleur réducteur.
...
#question(coups-de-pouce: (
  ...
  $ Delta_r H^circ &= 2 Delta_f H^circ(ce("H2O(l)")) = #quan[-570.2 kJ/mol] \
    Delta_r S^circ &= 2 times 69.96 - 2 times 130.46 - 204.82 = #quan[-325.8 J/mol/K] approx #quan[-0.326 kJ/mol/K] $
...
#question(coups-de-pouce: (
  ...
  À $#quan[298 K]$ et pressions standard, $e^circ = - Delta_r G^circ \/ (4 cal(F)) approx #quan[1.23 V] = E^circ(ce("O2/H2O")) - E^circ(cpl("H+", "H2"))$.
]

#question[
  Pour $p(ce("O2")) = p(ce("H2")) = #quan[1 bar]$, calculer la force électromotrice à $T = #quan[350 K]$.
][
  Le terme logarithmique est nul :
  $ e = - (Delta_r G^circ (350))/(4 cal(F)) = (570200 - 0.326 times 350 times 1000)/(4 times 96500) approx #quan[1.18 V] $
]
