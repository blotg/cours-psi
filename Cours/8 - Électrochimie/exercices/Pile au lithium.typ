...
Données : $E^circ(cpl("Li+", "Li")) = #quan[-3.0 V]$, $E^circ(ce("MnO2/MnO(OH)")) = #quan[1.0 V]$ ; masse de l'électrode de lithium $#quan[2.0 g]$, $M(ce("Li")) = #quan[6.9 g/mol]$ ; courant débité $I = #quan[0.1 mA]$ ; $#quan[1 A h] = #quan[3600 C]$.
...
#question(coups-de-pouce: (
  ...
  L'électrolyte n'est pas aqueux car $E^circ(cpl("Li+", "Li")) = #quan[-3.0 V]$ est très inférieur au potentiel de #ce("H2O/H2") : le lithium réagirait violemment avec l'eau ($2 ce("Li") + 2 ce("H2O") -> 2 ce("Li+") + 2 ce("HO^-") + ce("H2")$).
]
...
#question(coups-de-pouce: (
  ...
  $ n(ce("Li")) = 2.0 \/ 6.9 approx #quan[0.29 mol] $
  Chaque #ce("Li") libère un électron : $n_e = #quan[0.29 mol]$.
  $ Q = n_e cal(F) = 0.29 times 96500 approx #quan[2.8e4 C] = #quan[7.8 A h] $
]
...
#question[
  ...
  $ C_m = Q \/ m(ce("Li")) = 7.8 \/ (2.0 times 10^(-3)) approx #quan[3900 A h/kg] $
  C'est bien plus élevé que pour #ce("Cd"), #ce("Zn") ou #ce("Ag") : le lithium est très léger ($M = #quan[6.9 g/mol]$) et cède un électron par atome, d'où la grande densité d'énergie des piles au lithium.
]

#question[
  Calculer l'autonomie de la pile (en années).
][
  $ t = Q \/ I = (2.8 times 10^4) \/ (1 times 10^(-4)) = #quan[2.8e8 s] approx #quan[8.9 an] $
]
