...
#question(
    ...
    Si une OPPH s'écrit $underline(A_i)e^(j omega_i t)$ en $x=0$, comment s'écrit-elle après avoir parcouru une distance $x$ dans le milieu ?
][
...
#question()[
   ...
   Le paquet d'onde est plus large en $x$ qu'en $x=0$.
    ...
    On observe que les hautes fréquences arrivent plus vite que les basses fréquences : à une abscisse fixée, elles sont là plus tôt. C'est bien ce qu'annonce la vitesse de groupe $v_g = c sqrt(1 - omega_p^2 / omega^2)$, qui croît avec $omega$.
]
...
#question()[
    ...
    plt.show()
    ```
   On remarque qu'à $t$ fixé, les hautes fréquences sont à une abscisse plus grande : elles se sont propagées plus vite que les basses fréquences, ce qui confirme la réponse précédente.
]
