...
Un gaz de masse volumique $rho_0$ est enfermé dans une sphère rigide de rayon $R$. Une onde sonore sphérique s'y propage, décrite par la surpression $P_1(r, t)$ et la vitesse $v(r, t) va(e_r)$. On se place dans le cas
$ P_1(r, t) = A/r e^(j(omega_1 t - k_1 r)) + B/r e^(j(omega_2 t + k_2 r)) $

#question(coups-de-pouce: (
  "Pour chaque terme : stationnaire ou progressif ? harmonique ? sphérique, cylindrique ou plan ?",
))[
  Que représente chacun des termes de $P_1(r, t)$ ?
][
...
#question(coups-de-pouce: (
  ...
  Équation d'Euler : $rho_0 pdv(underline(v), t) = - pdv(underline(P_1), r)$, soit $j rho_0 omega thin underline(v) = - pdv(underline(P_1), r)$ pour une dépendance temporelle en $e^(j omega t)$.
...
#question(coups-de-pouce: (
  "Écrire la condition d'impénétrabilité en $r = R$ pour tout $t$.",
))[
  Établir le lien entre $omega_1$ et $omega_2$, puis entre $A$ et $B$. En déduire $underline(v)$.
][
  La condition d'impénétrabilité sur la paroi rigide impose $underline(v)(R, t) = 0$ pour tout $t$. Deux termes de pulsations différentes ne peuvent se compenser à tout instant : nécessairement $omega_1 = omega_2 equiv omega$, donc $k_1 = k_2 equiv k = omega \/ c$.
...
#question(coups-de-pouce: (
  "Pour que $P_1$ reste finie en $0$, relier simplement $A$ et $B$.",
  ...
  Près de $r = 0$, $P_1 approx (A e^(- j k r) + B e^(j k r))/r thin e^(j omega t)$. Pour que $P_1$ reste finie, il faut $A + B = 0$, soit $B = - A$. La surpression devient
  $ P_1(r, t) = - 2 j A (sin(k r))/r e^(j omega t) $
  (bien finie en $0$, puisque $sin(k r) \/ r -> k$).

  En reportant $B = - A$ dans la relation du 3, ou plus directement en réinjectant $P_1$ dans l'équation d'Euler puis la condition $v(R, t) = 0$, on obtient
