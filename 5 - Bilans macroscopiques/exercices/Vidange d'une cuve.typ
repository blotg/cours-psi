...
#question(
    ...
    On estime la section de la vanne à $S approx qty("10","cm^2")$ et le côté de la cuve à $a = 1 m$. On trouve alors
    #let a = 1
    #let S = 10e-4
    #let g = 9.81
